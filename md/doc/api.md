...
- argument keys (if not stated otherwise, possible values documented in [ListPages module](/doc:listpages-module)):
  - **site**: site to get pages from, e.g. "my-site"
...
- returns: page properties as dictionary (consult documentation of [ListPages module](/doc:listpages-module))
