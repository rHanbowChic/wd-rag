...
 * 在申请时应当提供按期完成的证据，可以是包含完工翻译的沙盒页面，或者暂时发布在alt:分类，再由管理移动。  
...
此外，如果这是一篇与他人的合译，我们也建议您在[[[attribution-metadata-translation|]]]进行标注。  
   
++ **更新版本**  
...
使用翻译工具作为辅助是允许的，只要最终成品质量达到标准。有时候少数错误和疏忽难以避免，我们鼓励校对者以修正和合作为主。如果你不能确定是否为低质量翻译，请尽可能优先将校对意见发布在评论区，供译者和其他校对者参考和评议。特别的，  
* 遣词造句  
* 版权模块作为法律声明，汉化可方便读者，但不汉化亦有其法律角度考量  
* 是否翻译人名  
属于译者的个人习惯使然，并不必然构成低质量翻译。  
